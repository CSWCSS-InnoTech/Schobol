...
#pragma warning restore 0618
        ...
        private void Resampler_Click(object sender, EventArgs e)
        {
            using (var S = new FileStream(
                @"C:\Users\user\Source\Repos\InnoTech-eLearning\InnoTecheLearning\InnoTecheLearning\InnoTecheLearning\Sounds\CNY.wav"
, FileMode.Open)) {
                var O = new StreamPlayerOptions(S);
                Output.Text = O.BitsPerSample.ToString() + ',' + O.Channels + ',' + O.Config + ',' + O.Duration.ToString()
                    + ',' + O.Format + ',' + O.SampleRate + ',' + O.Samples + ',' + O.SizeInBytes + ',' + O.Type;
        }
        }
