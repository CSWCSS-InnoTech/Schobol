...
namespace InnoTecheLearning
{
    partial class Utils
    {
        ...
        {
            return Do(Request(Post, "http://cloud.pedosa.org/platform/solutions/cswcss-innotech/test/index.php",
             "STUDENT_ID=s" + StudentID.ToString() + "&STUDENT_PASSPHRASE=" + PassPhrase)).Split(',');
        }
        public const string Get = "GET";
        public const string Post = "POST";
        public static async Task<string> Request(string Method, string URI, string Parameters)
            //, string ProxyString
        {
