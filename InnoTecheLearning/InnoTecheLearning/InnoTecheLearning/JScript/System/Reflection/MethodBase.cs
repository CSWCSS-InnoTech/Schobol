namespace System.Reflection
{
    ...
    public abstract class MethodBase : MemberInfo, _MethodBase
    {
        ...
        public bool IsAbstract =>
            ((this.Attributes & MethodAttributes.Abstract) != MethodAttributes.PrivateScope);

        public bool IsAssembly =>
            ((this.Attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Assembly);

        [ComVisible(true)]
        public bool IsConstructor =>
            (((this.Attributes & MethodAttributes.RTSpecialName) != MethodAttributes.PrivateScope) && this.Name.Equals(ConstructorInfo.ConstructorName));

        public bool IsFamily =>
            ((this.Attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Family);
        ...
        public bool IsFinal =>
            ((this.Attributes & MethodAttributes.Final) != MethodAttributes.PrivateScope);
        ...
        public bool IsHideBySig =>
            ((this.Attributes & MethodAttributes.HideBySig) != MethodAttributes.PrivateScope);
        ...
        public bool IsPrivate =>
            ((this.Attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Private);

        public bool IsPublic =>
            ((this.Attributes & MethodAttributes.MemberAccessMask) == MethodAttributes.Public);

        public bool IsSpecialName =>
            ((this.Attributes & MethodAttributes.SpecialName) != MethodAttributes.PrivateScope);

        public bool IsStatic =>
            ((this.Attributes & MethodAttributes.Static) != MethodAttributes.PrivateScope);

        public bool IsVirtual =>
            ((this.Attributes & MethodAttributes.Virtual) != MethodAttributes.PrivateScope);
