namespace System.Reflection
{
    ...
    internal static class CustomAttribute
    {
        ...
        internal static object[] GetCustomAttributes(Module decoratedModule, int decoratedMetadataToken, int pcaCount, RuntimeType attributeFilterType) => 
            GetCustomAttributes(decoratedModule, decoratedMetadataToken, pcaCount, attributeFilterType, false, null);
        ...
        internal static bool IsCustomAttributeDefined(Module decoratedModule, int decoratedMetadataToken, RuntimeType attributeFilterType) => 
            IsCustomAttributeDefined(decoratedModule, decoratedMetadataToken, attributeFilterType, false);
        ...
        internal static bool IsDefined(Assembly assembly, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(assembly, caType) || IsCustomAttributeDefined(assembly.ManifestModule, assembly.AssemblyHandle.GetToken(), caType));

        internal static bool IsDefined(Module module, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(module, caType) || IsCustomAttributeDefined(module, module.MetadataToken, caType));

        internal static bool IsDefined(ParameterInfo parameter, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(parameter, caType) || IsCustomAttributeDefined(parameter.Member.Module, parameter.MetadataToken, caType));

        internal static bool IsDefined(RuntimeConstructorInfo ctor, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(ctor, caType) || IsCustomAttributeDefined(ctor.Module, ctor.MetadataToken, caType));

        internal static bool IsDefined(RuntimeEventInfo e, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(e, caType) || IsCustomAttributeDefined(e.Module, e.MetadataToken, caType));

        internal static bool IsDefined(RuntimeFieldInfo field, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(field, caType) || IsCustomAttributeDefined(field.Module, field.MetadataToken, caType));

        internal static bool IsDefined(RuntimePropertyInfo property, RuntimeType caType) => 
            (PseudoCustomAttribute.IsDefined(property, caType) || IsCustomAttributeDefined(property.Module, property.MetadataToken, caType));
