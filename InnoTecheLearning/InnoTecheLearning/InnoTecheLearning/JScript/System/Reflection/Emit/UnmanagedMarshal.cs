namespace System.Reflection.Emit
{
    ...
    public sealed class UnmanagedMarshal
    {
        ...
        public static UnmanagedMarshal DefineByValArray(int elemCount) => 
            new UnmanagedMarshal(UnmanagedType.ByValArray, Guid.Empty, elemCount, (UnmanagedType) 0);

        public static UnmanagedMarshal DefineByValTStr(int elemCount) => 
            new UnmanagedMarshal(UnmanagedType.ByValTStr, Guid.Empty, elemCount, (UnmanagedType) 0);

        public static UnmanagedMarshal DefineLPArray(UnmanagedType elemType) => 
            new UnmanagedMarshal(UnmanagedType.LPArray, Guid.Empty, 0, elemType);

        public static UnmanagedMarshal DefineSafeArray(UnmanagedType elemType) => 
            new UnmanagedMarshal(UnmanagedType.SafeArray, Guid.Empty, 0, elemType);
