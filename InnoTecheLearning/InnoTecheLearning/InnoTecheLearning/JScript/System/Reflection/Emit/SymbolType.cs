namespace System.Reflection.Emit
{
    ...
    internal sealed class SymbolType : Type
    {
        ...
        protected override bool IsArrayImpl() => 
            (this.m_typeKind == TypeKind.IsArray);

        protected override bool IsByRefImpl() => 
            (this.m_typeKind == TypeKind.IsByRef);
        ...
        protected override bool IsPointerImpl() => 
            (this.m_typeKind == TypeKind.IsPointer);
        ...
        public override Type MakeArrayType() => 
            FormCompoundType((new string(this.m_bFormat) + "[]").ToCharArray(), this.m_baseType, 0);
