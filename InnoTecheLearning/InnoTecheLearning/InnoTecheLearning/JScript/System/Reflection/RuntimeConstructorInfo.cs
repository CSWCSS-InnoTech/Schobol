namespace System.Reflection
{
    ...
    internal sealed class RuntimeConstructorInfo : ConstructorInfo, ISerializable
    {
        ...
        internal override bool IsOverloaded =>
            (this.m_reflectedTypeCache.GetConstructorList(MemberListType.CaseSensitive, this.Name).Count > 1);
        ...
        public override System.Reflection.Module Module =>
            this.m_declaringType.GetTypeHandleInternal().GetModuleHandle().GetModule();

        public override string Name =>
            this.m_handle.GetName();
