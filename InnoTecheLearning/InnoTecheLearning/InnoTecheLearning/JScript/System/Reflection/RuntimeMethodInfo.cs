namespace System.Reflection
{
    ...
    internal sealed class RuntimeMethodInfo : MethodInfo, ISerializable
    {
        ...
        public override object[] GetCustomAttributes(bool inherit) => 
            CustomAttribute.GetCustomAttributes(this, typeof(object) as RuntimeType, inherit);
        ...
        public override int GetHashCode() => 
            this.GetMethodHandle().GetHashCode();
        ...
        public override MethodImplAttributes GetMethodImplementationFlags() => 
            this.m_handle.GetImplAttributes();
        ...
        public override object Invoke(object obj, System.Reflection.BindingFlags invokeAttr, Binder binder, object[] parameters, CultureInfo culture) => 
            this.Invoke(obj, invokeAttr, binder, parameters, culture, false);
        ...
        public override bool IsGenericMethod =>
            this.m_handle.HasMethodInstantiation();

        public override bool IsGenericMethodDefinition =>
            this.m_handle.IsGenericMethodDefinition();

        internal override bool IsOverloaded =>
            (this.m_reflectedTypeCache.GetMethodList(MemberListType.CaseSensitive, this.Name).Count > 1);

        public override MemberTypes MemberType =>
            MemberTypes.Method;

        public override int MetadataToken =>
            this.m_handle.GetMethodDef();
        ...
        private RuntimeTypeHandle ReflectedTypeHandle =>
            this.m_reflectedTypeCache.RuntimeTypeHandle;
