namespace System.Reflection
{
    ...
    internal sealed class RtFieldInfo : RuntimeFieldInfo, ISerializable
    {
        ...
        public override Type[] GetOptionalCustomModifiers() => 
            new Signature(this.m_fieldHandle, base.DeclaringTypeHandle).GetCustomModifiers(1, false);
        ...
        public override Type[] GetRequiredCustomModifiers() => 
            new Signature(this.m_fieldHandle, base.DeclaringTypeHandle).GetCustomModifiers(1, true);

        public override object GetValue(object obj) => 
            this.InternalGetValue(obj, true);
        ...
        internal object InternalGetValue(object obj, bool doVisibilityCheck) => 
            this.InternalGetValue(obj, doVisibilityCheck, true);
        ...
        public override int MetadataToken =>
            this.m_fieldHandle.GetToken();

        public override System.Reflection.Module Module =>
            this.m_fieldHandle.GetApproxDeclaringType().GetModuleHandle().GetModule();
