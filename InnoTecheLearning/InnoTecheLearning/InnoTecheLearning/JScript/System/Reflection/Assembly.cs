namespace System.Reflection
{
    ...
    public class Assembly : _Assembly, IEvidenceFactory, ICustomAttributeProvider, ISerializable
    {
        ...
        internal bool AptcaCheck(Assembly sourceAssembly) => 
            this.AssemblyHandle.AptcaCheck(sourceAssembly.AssemblyHandle);
        ...
        public object CreateInstance(string typeName) => 
            this.CreateInstance(typeName, false, BindingFlags.Public | BindingFlags.Instance, null, null, null, null);

        public object CreateInstance(string typeName, bool ignoreCase) => 
            this.CreateInstance(typeName, ignoreCase, BindingFlags.Public | BindingFlags.Instance, null, null, null, null);
        ...
        public virtual object[] GetCustomAttributes(bool inherit) => 
            CustomAttribute.GetCustomAttributes(this, typeof(object) as RuntimeType);
        ...
        public virtual Type[] GetExportedTypes() => 
            this.InternalAssembly._GetExportedTypes();
        ...
        internal string GetFullName() => 
            this.InternalAssembly._GetFullName();

        public override int GetHashCode() => 
            base.GetHashCode();

        private long GetHostContext() => 
            this.InternalAssembly._GetHostContext();

        public Module[] GetLoadedModules() => 
            this.nGetModules(false, false);

        public Module[] GetLoadedModules(bool getResourceModules) => 
            this.nGetModules(false, getResourceModules);
        ...
        internal string GetLocation() => 
            this.InternalAssembly._GetLocation();
        ...
        public virtual string[] GetManifestResourceNames() => 
            this.nGetManifestResourceNames();
        ...
        public Module GetModule(string name) => 
            this.GetModuleInternal(name);

        internal virtual Module GetModuleInternal(string name) => 
            this.InternalAssembly._GetModule(name);

        public Module[] GetModules() => 
            this.nGetModules(true, false);

        public Module[] GetModules(bool getResourceModules) => 
            this.nGetModules(true, getResourceModules);
        ...
        public AssemblyName[] GetReferencedAssemblies() => 
            this.InternalAssembly._GetReferencedAssemblies();

        private unsafe byte* GetResource(string resourceName, out ulong length, ref StackCrawlMark stackMark, bool skipSecurityCheck) => 
            this.InternalAssembly._GetResource(resourceName, out length, ref stackMark, skipSecurityCheck);

        public Assembly GetSatelliteAssembly(CultureInfo culture) => 
            this.InternalGetSatelliteAssembly(culture, null, true);

        public Assembly GetSatelliteAssembly(CultureInfo culture, Version version) => 
            this.InternalGetSatelliteAssembly(culture, version, true);

        public virtual Type GetType(string name) => 
            this.GetType(name, false, false);

        public virtual Type GetType(string name, bool throwOnError) => 
            this.GetType(name, throwOnError, false);

        public Type GetType(string name, bool throwOnError, bool ignoreCase) => 
            this.InternalAssembly._GetType(name, throwOnError, ignoreCase);
        ...
        public Module LoadModule(string moduleName, byte[] rawModule) => 
            this.nLoadModule(moduleName, rawModule, null, this.Evidence);

        public Module LoadModule(string moduleName, byte[] rawModule, byte[] rawSymbolStore) => 
            this.nLoadModule(moduleName, rawModule, rawSymbolStore, this.Evidence);
        ...
        internal static Module nDefineDynamicModule(Assembly containingAssembly, bool emitSymbolInfo, string filename, ref StackCrawlMark stackMark) => 
            _nDefineDynamicModule(containingAssembly.InternalAssembly, emitSymbolInfo, filename, ref stackMark);
        ...
        internal AssemblyHashAlgorithm nGetHashAlgorithm() => 
            this.InternalAssembly._nGetHashAlgorithm();

        private string nGetImageRuntimeVersion() => 
            this.InternalAssembly._nGetImageRuntimeVersion();

        internal Module nGetInMemoryAssemblyModule() => 
            this.InternalAssembly._nGetInMemoryAssemblyModule();

        private string nGetLocale() => 
            this.InternalAssembly._nGetLocale();
        ...
        private int nGetManifestResourceInfo(string resourceName, out Assembly assemblyRef, out string fileName, ref StackCrawlMark stackMark) => 
            this.InternalAssembly._nGetManifestResourceInfo(resourceName, out assemblyRef, out fileName, ref stackMark);

        internal string[] nGetManifestResourceNames() => 
            this.InternalAssembly._nGetManifestResourceNames();

        internal virtual Module[] nGetModules(bool loadIfNotFound, bool getResourceModules) => 
            this.InternalAssembly._nGetModules(loadIfNotFound, getResourceModules);

        internal Module nGetOnDiskAssemblyModule() => 
            this.InternalAssembly._nGetOnDiskAssemblyModule();

        internal byte[] nGetPublicKey() => 
            this.InternalAssembly._nGetPublicKey();

        internal string nGetSimpleName() => 
            this.InternalAssembly._nGetSimpleName();
        ...
        private bool nGlobalAssemblyCache() => 
            this.InternalAssembly._nGlobalAssemblyCache();

        internal bool nIsDynamic() => 
            this.InternalAssembly._nIsDynamic();
        ...
        private Module nLoadModule(string moduleName, byte[] rawModule, byte[] rawSymbolStore, System.Security.Policy.Evidence securityEvidence) => 
            this.InternalAssembly._nLoadModule(moduleName, rawModule, rawSymbolStore, securityEvidence);
        ...
        internal bool nReflection() => 
            this.InternalAssembly._nReflection();

        internal int nSaveExportedType(string strComTypeName, int tkAssemblyRef, int tkTypeDef, TypeAttributes flags) => 
            this.InternalAssembly._nSaveExportedType(strComTypeName, tkAssemblyRef, tkTypeDef, flags);
        ...
        internal int nSaveToFileList(string strFileName) => 
            this.InternalAssembly._nSaveToFileList(strFileName);

        internal int nSetHashValue(int tkFile, string strFullFileName) => 
            this.InternalAssembly._nSetHashValue(tkFile, strFullFileName);
        ...
        internal System.AssemblyHandle AssemblyHandle =>
            new System.AssemblyHandle((void*) this.m_assembly);
        ...
        public virtual string EscapedCodeBase =>
            AssemblyName.EscapeCodeBase(this.CodeBase);

        public virtual System.Security.Policy.Evidence Evidence =>
            this.nGetEvidence().Copy();
        ...
        {
            get { return this.InternalAssembly.m__assembly; }
            set
            {
        ...
        {
            get { return this.InternalAssembly.m__assemblyData; }
            set
            {
        ...
        {
            get { return this.InternalAssembly.m__cachedData; }
            set
            {
        ...
        private ModuleResolveEventHandler ModuleResolveEvent =>
            this.InternalAssembly._ModuleResolve;
