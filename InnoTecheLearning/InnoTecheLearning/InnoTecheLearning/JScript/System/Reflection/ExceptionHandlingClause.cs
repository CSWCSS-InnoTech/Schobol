namespace System.Reflection
{
    ...
    public sealed class ExceptionHandlingClause
    {
        ...
        public Type CatchType
        {
            get
            {
                ...
                if (!MetadataToken.IsNullToken(this.m_catchMetadataToken))
                {
                    ...
                    type = ((declaringType == null) ? this.m_methodBody.m_methodBase.Module : declaringType.Module).ResolveType(this.m_catchMetadataToken, declaringType?.GetGenericArguments(), (this.m_methodBody.m_methodBase is MethodInfo) ? this.m_methodBody.m_methodBase.GetGenericArguments() : null);
                }
                return type;
            }
        }
        ...
        public int HandlerLength =>
            this.m_handlerLength;

        public int HandlerOffset =>
            this.m_handlerOffset;
