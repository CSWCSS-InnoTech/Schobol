namespace System.Reflection
{
    ...
    internal sealed class RuntimePropertyInfo : PropertyInfo, ISerializable
    {
        ...
        internal bool EqualsSig(RuntimePropertyInfo target) => 
            System.Signature.DiffSigs(this.Signature, this.DeclaringType.GetTypeHandleInternal(), target.Signature, target.DeclaringType.GetTypeHandleInternal());
        ...
        public override Type[] GetOptionalCustomModifiers() => 
            this.Signature.GetCustomModifiers(0, false);

        public override object GetRawConstantValue() => 
            this.GetConstantValue(true);

        public override Type[] GetRequiredCustomModifiers() => 
            this.Signature.GetCustomModifiers(0, true);
        ...
        public override object GetValue(object obj, object[] index) => 
            this.GetValue(obj, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Instance, null, index, null);
        ...
        public override object GetValue(object obj, System.Reflection.BindingFlags invokeAttr, Binder binder, object[] index, CultureInfo culture) => 
            this.GetGetMethod(true)?.Invoke(obj, invokeAttr, binder, index, null);
        ...
        public override bool CanRead =>
            (this.m_getterMethod != null);

        public override bool CanWrite =>
            (this.m_setterMethod != null);
        ...
        public override Type PropertyType =>
            this.Signature.ReturnTypeHandle.GetRuntimeType();

        public override Type ReflectedType =>
            this.m_reflectedTypeCache.RuntimeType;
