namespace System.Reflection
{
    ...
    public class Module : _Module, ISerializable, ICustomAttributeProvider
    {
        ...
        internal virtual System.Reflection.Assembly GetAssemblyInternal() => 
            this.InternalModule._GetAssemblyInternal();

        public virtual object[] GetCustomAttributes(bool inherit) => 
            CustomAttribute.GetCustomAttributes(this, typeof(object) as System.RuntimeType);
        ...
        public FieldInfo[] GetFields() => 
            this.RuntimeType?.GetFields();

        public FieldInfo[] GetFields(BindingFlags bindingFlags) => 
            this.RuntimeType?.GetFields(bindingFlags);

        public override int GetHashCode() => 
            base.GetHashCode();

        internal IntPtr GetHINSTANCE() => 
            this.InternalModule._GetHINSTANCE();
        ...
        public MethodInfo[] GetMethods() => 
            this.RuntimeType?.GetMethods();

        public MethodInfo[] GetMethods(BindingFlags bindingFlags) => 
            this.RuntimeType?.GetMethods(bindingFlags);

        internal unsafe System.ModuleHandle GetModuleHandle() => 
            new System.ModuleHandle((void*) this.m_pData);
        ...
        public X509Certificate GetSignerCertificate() => 
            this.GetSignerCertificateInternal();

        internal X509Certificate GetSignerCertificateInternal() => 
            this.InternalModule._GetSignerCertificateInternal();
        ...
        public virtual Type GetType(string className, bool throwOnError, bool ignoreCase) => 
            this.GetTypeInternal(className, throwOnError, ignoreCase);

        internal Type GetTypeInternal(string className, bool ignoreCase, bool throwOnError) => 
            this.InternalModule._GetTypeInternal(className, ignoreCase, throwOnError);
        ...
        internal Type[] GetTypesInternal(ref StackCrawlMark stackMark) => 
            this.InternalModule._GetTypesInternal(ref stackMark);
        ...
        private FieldInfo InternalGetField(string name, BindingFlags bindingAttr) => 
            this.RuntimeType?.GetField(name, bindingAttr);

        internal string InternalGetFullyQualifiedName() => 
            this.InternalModule._InternalGetFullyQualifiedName();

        internal int InternalGetMemberRef(Module refedModule, int tr, int defToken) => 
            this.InternalModule._InternalGetMemberRef(refedModule.InternalModule, tr, defToken);

        internal int InternalGetMemberRefFromSignature(int tr, string methodName, byte[] signature, int length) => 
            this.InternalModule._InternalGetMemberRefFromSignature(tr, methodName, signature, length);

        internal int InternalGetMemberRefOfFieldInfo(int tkType, RuntimeTypeHandle declaringType, int tkField) => 
            this.InternalModule._InternalGetMemberRefOfFieldInfo(tkType, declaringType.Value, tkField);

        internal int InternalGetMemberRefOfMethodInfo(int tr, RuntimeMethodHandle method) => 
            this.InternalModule._InternalGetMemberRefOfMethodInfo(tr, method.Value);

        private string InternalGetName() => 
            this.InternalModule._InternalGetName();

        internal int InternalGetStringConstant(string str) => 
            this.InternalModule._InternalGetStringConstant(str);

        internal int InternalGetTypeSpecTokenWithBytes(byte[] signature, int length) => 
            this.InternalModule._InternalGetTypeSpecTokenWithBytes(signature, length);

        internal int InternalGetTypeToken(string strFullName, Module refedModule, string strRefedModuleFileName, int tkResolution) => 
            this.InternalModule._InternalGetTypeToken(strFullName, refedModule.InternalModule, strRefedModuleFileName, tkResolution);

        internal Type InternalLoadInMemoryTypeByName(string className) => 
            this.InternalModule._InternalLoadInMemoryTypeByName(className);
        ...
        public bool IsResource() => 
            this.IsResourceInternal();

        internal bool IsResourceInternal() => 
            this.InternalModule._IsResourceInternal();

        internal int nativeGetArrayMethodToken(int tkTypeSpec, string methodName, byte[] signature, int sigLength, int baseToken) => 
            this.InternalModule._nativeGetArrayMethodToken(tkTypeSpec, methodName, signature, sigLength, baseToken);

        public FieldInfo ResolveField(int metadataToken) => 
            this.ResolveField(metadataToken, null, null);
        ...
        public MemberInfo ResolveMember(int metadataToken) => 
            this.ResolveMember(metadataToken, null, null);
        ...
        public MethodBase ResolveMethod(int metadataToken) => 
            this.ResolveMethod(metadataToken, null, null);
        ...
        public Type ResolveType(int metadataToken) => 
            this.ResolveType(metadataToken, null, null);
        ...
        {
            get { return this.InternalModule.m__EntryPoint; }
            set
            {
        ...
        {
            get { return this.InternalModule.m__iSymWriter; }
            set
            {
        ...
        {
            get { return this.InternalModule.m__moduleData; }
            set
            {
        ...
        internal IntPtr m_pData =>
            this.InternalModule.m__pData;

        private IntPtr m_pFields =>
            this.InternalModule.m__pFields;

        private IntPtr m_pGlobals =>
            this.InternalModule.m__pGlobals;

        internal IntPtr m_pInternalSymWriter =>
            this.InternalModule.m__pInternalSymWriter;

        private IntPtr m_pRefClass =>
            this.InternalModule.m__pRefClass;

        private System.RuntimeType m_runtimeType
        {
            get { return this.InternalModule.m__runtimeType; }
            set
            {
        ...
        {
            get { return this.InternalModule.m__TypeBuilderList; }
            set
            {
        ...
        public int MDStreamVersion =>
            this.GetModuleHandle().MDStreamVersion;

        internal System.Reflection.MetadataImport MetadataImport =>
            this.ModuleHandle.GetMetadataImport();

        public int MetadataToken =>
            this.GetModuleHandle().GetToken();
