namespace System.Reflection
{
    ...
    public class ParameterInfo : _ParameterInfo, ICustomAttributeProvider
    {
        ...
        public override string ToString() => 
            (this.ParameterType.SigToString() + " " + this.Name);
        ...
        public bool IsIn =>
            ((this.Attributes & ParameterAttributes.In) != ParameterAttributes.None);

        public bool IsLcid =>
            ((this.Attributes & ParameterAttributes.Lcid) != ParameterAttributes.None);

        private bool IsLegacyParameterInfo =>
            (base.GetType() != typeof(ParameterInfo));

        public bool IsOptional =>
            ((this.Attributes & ParameterAttributes.Optional) != ParameterAttributes.None);

        public bool IsOut =>
            ((this.Attributes & ParameterAttributes.Out) != ParameterAttributes.None);

        public bool IsRetval =>
            ((this.Attributes & ParameterAttributes.Retval) != ParameterAttributes.None);
