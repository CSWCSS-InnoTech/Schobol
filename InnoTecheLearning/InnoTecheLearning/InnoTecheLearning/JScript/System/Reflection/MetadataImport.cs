namespace System.Reflection
{
    ...
    internal struct MetadataImport
    {
        ...
        public override int GetHashCode() => 
            this.m_metadataImport2.GetHashCode();

        public override bool Equals(object obj) => 
            ((obj is MetadataImport) && this.Equals((MetadataImport) obj));

        internal bool Equals(MetadataImport import) => 
            (import.m_metadataImport2 == this.m_metadataImport2);
        ...
        public int EnumNestedTypesCount(int mdTypeDef) => 
            this.EnumCount(0x2000000, mdTypeDef);
        ...
        public int EnumCustomAttributesCount(int mdToken) => 
            this.EnumCount(0xc000000, mdToken);
        ...
        public int EnumParamsCount(int mdMethodDef) => 
            this.EnumCount(0x8000000, mdMethodDef);
        ...
        public int GetAssociatesCount(int mdPropEvent) => 
            this.EnumCount(0x6000000, mdPropEvent);
        ...
        public int EnumFieldsCount(int mdTypeDef) => 
            this.EnumCount(0x4000000, mdTypeDef);
        ...
        public int EnumPropertiesCount(int mdTypeDef) => 
            this.EnumCount(0x17000000, mdTypeDef);
        ...
        public int EnumEventsCount(int mdTypeDef) => 
            this.EnumCount(0x14000000, mdTypeDef);
        ...
        public bool GetFieldOffset(int typeTokenDef, int fieldTokenDef, out int offset) => 
            _GetFieldOffset(this.m_metadataImport2, out MetadataArgs.Skip, typeTokenDef, fieldTokenDef, out offset);
        ...
        public bool IsValidToken(int token) => 
            _IsValidToken(this.m_metadataImport2, out MetadataArgs.Skip, token);
