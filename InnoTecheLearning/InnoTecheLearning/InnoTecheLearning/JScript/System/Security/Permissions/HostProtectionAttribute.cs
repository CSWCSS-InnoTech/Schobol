namespace System.Security.Permissions
{
    ...
    public sealed class HostProtectionAttribute : CodeAccessSecurityAttribute
    {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.ExternalProcessMgmt) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.ExternalThreading) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.MayLeakOnAbort) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.SecurityInfrastructure) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.SelfAffectingProcessMgmt) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.SelfAffectingThreading) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.SharedState) != HostProtectionResource.None); }
            set
            {
        ...
        {
            get { return ((this.m_resources & HostProtectionResource.Synchronization) != HostProtectionResource.None); }
            set
            {
        ...
        public bool UI
        {
            get { return ((this.m_resources & HostProtectionResource.UI) != HostProtectionResource.None); }
            set
            {
