namespace System.Security
{
    ...
    public sealed class SecurityElement : ISecurityElementFactory
    {
        ...
        public SecurityElement Copy() => 
            new SecurityElement(this.m_strTag, this.m_strText) { 
        ...
        public static bool IsValidAttributeValue(string value) => 
            (value?.IndexOfAny(s_valueIllegalCharacters) == -1);

        public static bool IsValidTag(string tag) => 
            (tag?.IndexOfAny(s_tagIllegalCharacters) == -1);

        public static bool IsValidText(string text) => 
            (text?.IndexOfAny(s_textIllegalCharacters) == -1);
