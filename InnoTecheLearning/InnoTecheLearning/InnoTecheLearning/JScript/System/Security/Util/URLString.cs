namespace System.Security.Util
{
    ...
    internal sealed class URLString : SiteString
    {
        ...
        public override SiteString Copy() => 
            new URLString(this.m_urlOriginal, this.m_parsedOriginal);
        ...
        internal static string PreProcessForExtendedPathRemoval(string url, bool isFileUrl)
        {
            ...
            if (isFileUrl)
            {
                builder.Replace('\\', '/');
                int length = 0;
                while ((length < builder.Length) && (builder[length] == '/'))
                {
                    length++;
                }
        ...
        internal URLString SpecialNormalizeUrl()
        {
            ...
            string str2 = _GetDeviceName(driveLetter);
            if (str2 == null)
            {
                return this;
            }
            ...
            {
                URLString str3 = new URLString(str2 + "/" + this.m_directory.ToString());
                str3.DoDeferredParse();
                return str3;
            }
            URLString str4 = new URLString("file://" + str2 + "/" + this.m_directory.ToString());
