namespace System.Security.Util
{
    ...
    internal class SiteString
    {
        ...
        public virtual SiteString Copy() => 
            new SiteString(this.m_site, this.m_separatedSite);
        ...
        public override bool Equals(object o) => 
            (((o != null) && (o is SiteString)) && this.Equals((SiteString) o, true));
        ...
        public override int GetHashCode() => 
            CultureInfo.InvariantCulture.TextInfo.GetCaseInsensitiveHashCode(this.m_site);
