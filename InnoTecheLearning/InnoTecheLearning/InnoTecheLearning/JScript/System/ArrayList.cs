namespace System.Collections
{
    ...
    [Serializable, ComVisible(true), DebuggerTypeProxy(typeof(ArrayListDebugView)), DebuggerDisplay("Count = {Count}")]
    public class ArrayList : IList, ICollection, IEnumerable, ICloneable
    {
        ...
        public virtual int BinarySearch(int index, int count, object value, IComparer comparer)
        {
            if ((index < 0) || (count < 0))
            {
                throw new ArgumentOutOfRangeException((index < 0) ? "index" : "count", "Number must be non-negative.");
            }
            if ((this._size - index) < count)
            {
                throw new ArgumentException("Len must not exceed the array's length.");
            }
        ...
        public virtual int LastIndexOf(object value, int startIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException((startIndex < 0) ? "startIndex" : "count", "Number must be non-negative.");
            }
        ...
        public static ArrayList Repeat(object value, int count)
        {
            if (count < 0)
            {
                throw new ArgumentOutOfRangeException("count", "Number must be non-negative.");
            }
        ...
        private sealed class ArrayListEnumerator : IEnumerator, ICloneable
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw new InvalidOperationException("Enumerator's version is failed.");
                }
            ...
            public object Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException("Enumerating has not been started.");
                    }
                    if (this.index > this.endIndex)
                    {
                        throw new InvalidOperationException("Enumerating has ended.");
                    }
        ...
        private class IListWrapper : ArrayList
        {
            ...
            public override void CopyTo(int index, Array array, int arrayIndex, int count)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException((index < 0) ? "index" : "arrayIndex", "Number must be non-negative.");
                }
                if (count < 0)
                {
                    throw new ArgumentOutOfRangeException("count", "Number must be non-negative.");
        ...
        private class Range : ArrayList
        {
            ...
            public override void CopyTo(Array array, int index)
            {
                ...
                if (index < 0)
                {
                    throw new ArgumentOutOfRangeException("index", "Number must be non-negative.");
                }
            ...
            public override int IndexOf(object value, int startIndex)
            {
                ...
                if (startIndex < 0)
                {
                    throw new ArgumentOutOfRangeException("startIndex", "Number must be non-negative.");
                }
            ...
            public override int Capacity
            {
                get { return this._baseList.Capacity; }
                set
                {
                    if (value < this.Count)
                    {
