namespace Microsoft.JScript
{
    ...
    internal sealed class VsaHostObject : VsaItem, IVsaGlobalItem, IVsaItem
    {
        ...
        internal VsaHostObject(VsaEngine engine, string itemName, VsaItemType type) : this(engine, itemName, type, null)
        {
        }

        internal VsaHostObject(VsaEngine engine, string itemName, VsaItemType type, VsaScriptScope scope) : base(engine, itemName, type, VsaItemFlag.None)
        {
