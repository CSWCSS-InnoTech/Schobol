namespace Microsoft.JScript
{
    ...
    internal sealed class JSCodeGenerator : CodeCompiler
    {
        ...
        protected override bool IsValidIdentifier(string value) => 
            (((value != null) && (value.Length != 0)) && VsaEngine.CreateEngine().IsValidIdentifier(value));
        ...
        protected override string QuoteSnippetString(string value) => 
            this.QuoteSnippetStringCStyle(value);
        ...
        protected override bool Supports(GeneratorSupport support) => 
            ((support & (GeneratorSupport.PublicStaticMembers | GeneratorSupport.AssemblyAttributes | GeneratorSupport.DeclareInterfaces | GeneratorSupport.DeclareEnums | GeneratorSupport.TryCatchStatements | GeneratorSupport.StaticConstructors | GeneratorSupport.MultidimensionalArrays | GeneratorSupport.EntryPointMethod | GeneratorSupport.ArraysOfArrays)) == support);
