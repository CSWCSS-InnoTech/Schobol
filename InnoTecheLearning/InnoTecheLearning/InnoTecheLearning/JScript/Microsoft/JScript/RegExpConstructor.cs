namespace Microsoft.JScript
{
    ...
    public sealed class RegExpConstructor : ScriptFunction
    {
        ...
        public object Construct(string pattern, bool ignoreCase, bool global, bool multiline) => 
            new RegExpObject(this.originalPrototype, pattern, ignoreCase, global, multiline, this);
        ...
        private object GetIndex() => 
            ((this.lastRegexMatch == null) ? -1 : this.lastRegexMatch.Index);

        private object GetInput() => 
            this.inputString;

        private object GetLastIndex() => 
            ((this.lastRegexMatch == null) ? -1 : ((this.lastRegexMatch.Length == 0) ? (this.lastRegexMatch.Index + 1) : (this.lastRegexMatch.Index + this.lastRegexMatch.Length)));
