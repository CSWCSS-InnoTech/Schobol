namespace Microsoft.JScript
{
    ...
    public class DateConstructor : ScriptFunction
    {
        ...
        internal DateObject Construct(DateTime dt) => 
            new DateObject(this.originalPrototype, (((double) dt.ToUniversalTime().Ticks) / 10000.0) - 62135596800000);
        ...
        public string Invoke() => 
            DatePrototype.DateToString((((double) DateTime.Now.ToUniversalTime().Ticks) / 10000.0) - 62135596800000);

        [JSFunction(JSFunctionAttributeEnum.None, JSBuiltin.Date_parse)]
        public static double parse(string str) => 
            DatePrototype.ParseDate(str);
