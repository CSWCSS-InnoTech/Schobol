namespace Microsoft.JScript
{
    ...
    public class StringPrototype : StringObject
    {
        ...
        public static string @fixed(object thisob) => 
            ("<TT>" + Microsoft.JScript.Convert.ToString(thisob) + "</TT>");
        ...
        public static string italics(object thisob) => 
            ("<I>" + Microsoft.JScript.Convert.ToString(thisob) + "</I>");
        ...
        public static int localeCompare(object thisob, object thatob) => 
            string.Compare(Microsoft.JScript.Convert.ToString(thisob), Microsoft.JScript.Convert.ToString(thatob), StringComparison.CurrentCulture);
        ...
        public static string small(object thisob) => 
            ("<SMALL>" + Microsoft.JScript.Convert.ToString(thisob) + "</SMALL>");
        ...
        public static string strike(object thisob) => 
            ("<STRIKE>" + Microsoft.JScript.Convert.ToString(thisob) + "</STRIKE>");

        [JSFunction(JSFunctionAttributeEnum.HasThisObject, JSBuiltin.String_sub)]
        public static string sub(object thisob) => 
            ("<SUB>" + Microsoft.JScript.Convert.ToString(thisob) + "</SUB>");

        [JSFunction(JSFunctionAttributeEnum.HasThisObject, JSBuiltin.String_substr), NotRecommended("substr")]
        ...
        public static string sup(object thisob) => 
            ("<SUP>" + Microsoft.JScript.Convert.ToString(thisob) + "</SUP>");
        ...
        public static string toLocaleLowerCase(object thisob) => 
            Microsoft.JScript.Convert.ToString(thisob).ToLower(CultureInfo.CurrentUICulture);
        ...
        public static string toLocaleUpperCase(object thisob) => 
            Microsoft.JScript.Convert.ToString(thisob).ToUpperInvariant();
        ...
        public static string toLowerCase(object thisob) => 
            Microsoft.JScript.Convert.ToString(thisob).ToLowerInvariant();
