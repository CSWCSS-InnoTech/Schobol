namespace Microsoft.JScript
{
    ...
    internal class JSInProcCompiler
    {
        ...
        {
            IVsaReferenceItem item = (IVsaReferenceItem) engine.Items.CreateItem(filename, VsaItemType.Reference, VsaItemFlag.None);
        ...
        private void AddSourceFile(VsaEngine engine, string filename)
        {
            ...
            IVsaCodeItem item = (IVsaCodeItem) engine.Items.CreateItem(name, VsaItemType.Code, VsaItemFlag.None);
        ...
        internal int Compile(CompilerParameters options, string partialCmdLine, string[] sourceFiles, string outputFile)
        {
            ...
            try
            {
                ...
                {
                    if (exception3.ErrorCode == VsaError.AssemblyExpected)
                    {
                    ...
                    else if (exception3.ErrorCode == VsaError.SaveCompiledStateFailed)
                    {
        ...
        internal void PrintBanner(VsaEngine engine, TextWriter output)
        {
            ...
            strArray[0] = 8.ToString(CultureInfo.InvariantCulture);
            strArray[1] = ".";
            int num2 = 0;
