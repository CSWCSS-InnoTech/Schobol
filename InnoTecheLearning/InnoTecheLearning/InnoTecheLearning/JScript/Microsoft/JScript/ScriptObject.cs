namespace Microsoft.JScript
{
    ...
    public abstract class ScriptObject : IReflect
    {
        ...
        public MethodInfo GetMethod(string name, BindingFlags bindingAttr) => 
            this.GetMethod(name, bindingAttr, JSBinder.ob, Type.EmptyTypes, null);
        ...
        public PropertyInfo GetProperty(string name, BindingFlags bindingAttr) => 
            this.GetProperty(name, bindingAttr, JSBinder.ob, null, Type.EmptyTypes, null);
        ...
        internal virtual object GetValueAtIndex(uint index) => 
            this.GetMemberValue(index.ToString(CultureInfo.CurrentUICulture));
        ...
        protected static MemberInfo[] WrapMembers(MemberInfo member, object obj) => 
            new MemberInfo[] { WrapMember(member, obj) };
