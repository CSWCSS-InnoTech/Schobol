namespace Microsoft.JScript
{
    ...
    public class GlobalObject
    {
        ...
        public static string decodeURI(object encodedURI) => 
            Decode(encodedURI, URISetType.Reserved);
        ...
        public static string decodeURIComponent(object encodedURI) => 
            Decode(encodedURI, URISetType.None);
        ...
        public static string encodeURI(object uri) => 
            Encode(uri, URISetType.Unescaped | URISetType.Reserved);
        ...
        public static string encodeURIComponent(object uriComponent) => 
            Encode(uriComponent, URISetType.Unescaped);
        ...
        public static double parseFloat(object @string) => 
            Microsoft.JScript.Convert.ToNumber(Microsoft.JScript.Convert.ToString(@string), false, false, Missing.Value);
        ...
        public static double parseInt(object @string, object radix) => 
            Microsoft.JScript.Convert.ToNumber(Microsoft.JScript.Convert.ToString(@string), true, true, radix);
        ...
        [NotRecommended("unescape"), JSFunction(JSFunctionAttributeEnum.None, JSBuiltin.Global_unescape)]
        ...
        public static NumberConstructor Number =>
            NumberConstructor.ob;

        public static ObjectConstructor Object =>
            ObjectConstructor.ob;
