namespace Microsoft.JScript
{
    ...
    internal sealed class ClassScope : ActivationObject, IComparable
    {
        ...
        protected override JSVariableField CreateField(string name, FieldAttributes attributeFlags, object value) => 
            new JSMemberField(this, name, value, attributeFlags);
        ...
        internal object FakeCallToTypeMethod(MethodInfo method, object[] arguments, Exception e)
        {
            ...
            return typeof(ClassScope).GetMethod(method.Name, types)?.Invoke(this, arguments);
        }
        ...
        public FieldInfo GetField(string name) => 
            base.GetField(name, BindingFlags.Public | BindingFlags.Instance);
        ...
        public MethodInfo GetMethod(string name) => 
            base.GetMethod(name, BindingFlags.Public | BindingFlags.Instance);
        ...
        public PropertyInfo GetProperty(string name) => 
            base.GetProperty(name, BindingFlags.Public | BindingFlags.Instance);
        ...
        internal TypeBuilder GetTypeBuilder() => 
            ((TypeBuilder) this.GetTypeBuilderOrEnumBuilder());
