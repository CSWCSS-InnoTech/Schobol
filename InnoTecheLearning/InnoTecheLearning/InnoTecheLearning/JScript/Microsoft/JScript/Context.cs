namespace Microsoft.JScript
{
    ...
    public class Context
    {
        ...
        internal Context Clone() => 
            new Context(this.document, this.source_string, this.lineNumber, this.startLinePos, this.startPos, this.endLineNumber, this.endLinePos, this.endPos, this.token) { errorReported = this.errorReported };

        internal Context CombineWith(Context other) => 
            new Context(this.document, this.source_string, this.lineNumber, this.startLinePos, this.startPos, other.endLineNumber, other.endLinePos, other.endPos, this.token);
        ...
        internal bool Equals(Context ctx) => 
            (((((this.source_string == ctx.source_string) && (this.lineNumber == ctx.lineNumber)) && ((this.startLinePos == ctx.startLinePos) && (this.startPos == ctx.startPos))) && (((this.endLineNumber == ctx.endLineNumber) && (this.endLinePos == ctx.endLinePos)) && (this.endPos == ctx.endPos))) && (this.token == ctx.token));
        ...
        public int StartColumn =>
            (this.startPos - this.startLinePos);
