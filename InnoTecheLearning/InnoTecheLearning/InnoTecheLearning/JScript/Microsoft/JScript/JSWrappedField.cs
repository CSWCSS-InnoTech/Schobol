namespace Microsoft.JScript
{
    ...
    internal sealed class JSWrappedField : JSField, IWrappedMember
    {
        ...
        public override object GetValue(object obj) => 
            this.wrappedField.GetValue(this.wrappedObject);
        ...
        public override FieldAttributes Attributes =>
            this.wrappedField.Attributes;

        public override Type DeclaringType =>
            this.wrappedField.DeclaringType;

        public override Type FieldType =>
            this.wrappedField.FieldType;

        public override string Name =>
            this.wrappedField.Name;
    }
}
