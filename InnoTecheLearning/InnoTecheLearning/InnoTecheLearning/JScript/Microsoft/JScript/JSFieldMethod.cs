namespace Microsoft.JScript
{
    ...
    internal sealed class JSFieldMethod : JSMethod
    {
        ...
        internal override object Construct(object[] args) => 
            LateBinding.CallValue(this.field.GetValue(base.obj), args, true, false, ((ScriptObject) base.obj).engine, null, JSBinder.ob, null, null);
        ...
        internal override MethodInfo GetMethodInfo(CompilerGlobals compilerGlobals) => 
            this.func.GetMethodInfo(compilerGlobals);
        ...
        internal bool IsAccessibleFrom(ScriptObject scope) => 
            ((JSMemberField) this.field).IsAccessibleFrom(scope);
