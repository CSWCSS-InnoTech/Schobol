namespace Microsoft.JScript
{
    ...
    internal sealed class Member : Binding
    {
        ...
        protected override object GetObject() => 
            Microsoft.JScript.Convert.ToObject(this.rootObject.Evaluate(), base.Engine);
        ...
        public override string ToString() => 
            (this.rootObject.ToString() + "." + base.name);
        ...
        protected override void TranslateToILWithDupOfThisOb(ILGenerator il)
        {
            ...
            if (((ir == Typeob.Object) || (ir == Typeob.String)) || ((ir is TypedArray) || ((ir == rtype) && Typeob.Array.IsAssignableFrom(rtype))))
            {
                rtype = Typeob.Object;
