namespace Microsoft.JScript
{
    ...
    internal class Call : AST
    {
        ...
        {
            object[] objArray = this.args?.EvaluateAsArray();
        ...
        internal override object Evaluate()
        {
            ...
            {
                throw new JScriptException(JSError.NonClsException, base.context);
            }
            finally
            {
        ...
        internal IdentifierLiteral GetName() => 
            new IdentifierLiteral(this.func.ToString(), this.func.context);
        ...
        internal Microsoft.JScript.CustomAttribute ToCustomAttribute() => 
            new Microsoft.JScript.CustomAttribute(base.context, this.func, this.args);
