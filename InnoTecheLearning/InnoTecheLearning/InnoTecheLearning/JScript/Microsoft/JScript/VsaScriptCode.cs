namespace Microsoft.JScript
{
    ...
    internal class VsaScriptCode : VsaItem, IVsaScriptCodeItem, IVsaCodeItem, IVsaItem, IDebugVsaScriptCodeItem
    {
        ...
        internal VsaScriptCode(VsaEngine engine, string itemName, VsaItemType type, IVsaScriptScope scope) : base(engine, itemName, type, VsaItemFlag.None)
        {
        ...
        internal override void Compile()
        {
            if (this.binaryCode == null)
            {
                ...
                if (base.ItemType == ((VsaItemType) 0x16))
                {
