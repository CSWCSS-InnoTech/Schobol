    ...
    public abstract class BinaryOp : AST
    {
        ...
        protected MethodInfo GetOperator(IReflect ir1, IReflect ir2)
        {
            ...
            if ((this.type1 != c) || (this.type2 != type2))
            {
                ...
                {
                    MethodInfo info2 = c?.GetMethod(name, BindingFlags.Public | BindingFlags.Static, JSBinder.ob, types, null);
                    MethodInfo info3 = type2?.GetMethod(name, BindingFlags.Public | BindingFlags.Static, JSBinder.ob, types, null);
