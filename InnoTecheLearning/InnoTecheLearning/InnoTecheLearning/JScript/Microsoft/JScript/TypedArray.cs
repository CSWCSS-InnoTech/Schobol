namespace Microsoft.JScript
{
    ...
    public sealed class TypedArray : IReflect
    {
        ...
        public FieldInfo GetField(string name, BindingFlags bindingAttr) => 
            Typeob.Array.GetField(name, bindingAttr);

        public FieldInfo[] GetFields(BindingFlags bindingAttr) => 
            Typeob.Array.GetFields(bindingAttr);
        ...
        public MemberInfo[] GetMembers(BindingFlags bindingAttr) => 
            Typeob.Array.GetMembers(bindingAttr);

        public MethodInfo GetMethod(string name, BindingFlags bindingAttr) => 
            Typeob.Array.GetMethod(name, bindingAttr);

        public MethodInfo GetMethod(string name, BindingFlags bindingAttr, Binder binder, Type[] types, ParameterModifier[] modifiers) => 
            Typeob.Array.GetMethod(name, bindingAttr, binder, types, modifiers);

        public MethodInfo[] GetMethods(BindingFlags bindingAttr) => 
            Typeob.Array.GetMethods(bindingAttr);

        public PropertyInfo[] GetProperties(BindingFlags bindingAttr) => 
            Typeob.Array.GetProperties(bindingAttr);
