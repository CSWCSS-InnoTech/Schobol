namespace Microsoft.JScript.Vsa
{
    ...
    [Obsolete("Use of this type is not recommended because it is being deprecated in Visual Studio 2005; there will be no replacement for this feature. Please see the ICodeCompiler documentation for additional help."), Guid("B71E484D-93ED-4b56-BFB9-CEED5134822B"), ComVisible(true)]
    public sealed class VsaEngine : BaseVsaEngine, IEngine2, IRedirectOutput
    {
        ...
        private void AddReferences()
        {
            ...
            if (strArray != null)
            {
                ...
                {
                    VsaReference reference = (VsaReference) base.vsaItems.CreateItem(strArray[i], VsaItemType.Reference, VsaItemFlag.None);
            ...
            else
            {
                ...
                for (int j = 0; j < objArray.Length; j++)
                {
                    ...
                    VsaReference reference2 = (VsaReference) base.vsaItems.CreateItem(name, VsaItemType.Reference, VsaItemFlag.None);
        ...
        public static GlobalScope CreateEngineAndGetGlobalScope(bool fast, string[] assemblyNames)
        {
            ...
            {
                VsaReference reference = (VsaReference) engine.vsaItems.CreateItem(str, VsaItemType.Reference, VsaItemFlag.None);
        ...
        public static GlobalScope CreateEngineAndGetGlobalScopeWithType(bool fast, string[] assemblyNames, RuntimeTypeHandle callingTypeHandle) => 
            CreateEngineAndGetGlobalScopeWithTypeAndRootNamespace(fast, assemblyNames, callingTypeHandle, null);
        ...
        protected override bool DoCompile()
        {
            ...
            if (base.isEngineCompiled)
            {
                if (this.doSaveAfterCompile)
                {
                    ...
                    {
                        throw new VsaException(VsaError.SaveCompiledStateFailed, exception5.Message, exception5);
                    }
                    catch
                    {
        ...
        protected override void DoLoadSourceState(IVsaPersistSite site)
        {
            ...
            {
                throw new VsaException(VsaError.UnknownError, exception.ToString(), exception);
            }
            catch
            {
        ...
        protected override void DoSaveCompiledState(out byte[] pe, out byte[] pdb)
        {
            ...
            if (this.rawPE == null)
            {
                ...
                {
                    throw new VsaException(VsaError.SaveCompiledStateFailed, exception.ToString(), exception);
                }
                catch
                {
                    throw new VsaException(VsaError.SaveCompiledStateFailed);
        ...
        internal void EnsureReflectionOnlyModulesLoaded()
        {
            ...
            {
                reflectionOnlyVsaModule = Assembly.ReflectionOnlyLoadFrom(typeof(IVsaEngine).Assembly.Location).GetModule("Microsoft.Vsa.dll");
        ...
        public ArrayConstructor GetOriginalArrayConstructor() => 
            this.Globals.globalObject.originalArray;

        public ObjectConstructor GetOriginalObjectConstructor() => 
            this.Globals.globalObject.originalObject;

        public RegExpConstructor GetOriginalRegExpConstructor() => 
            this.Globals.globalObject.originalRegExp;
        ...
        private JSScanner GetScannerInstance(string name)
        {
            ...
            VsaItem sourceItem = new VsaStaticCode(this, "itemName", VsaItemFlag.None);
        ...
        internal int GetStaticCodeBlockCount() => 
            ((VsaItems) base.vsaItems).staticCodeBlockCount;
        ...
        private Version LoadProjectVersion(XmlElement root) => 
            new Version(root["ProjectVersion"].GetAttribute("Version"));
        ...
        private void LoadVsaItems(XmlElement parent)
        {
            ...
            string strB = VsaItemType.Reference.ToString();
            string str3 = VsaItemType.AppGlobal.ToString();
            string str4 = VsaItemType.Code.ToString();
            foreach (XmlElement element in childNodes)
            {
                ...
                {
                    item = base.vsaItems.CreateItem(attribute, VsaItemType.Reference, VsaItemFlag.None);
                    ((IVsaReferenceItem) item).AssemblyName = element.GetAttribute("AssemblyName");
                }
                else if (string.Compare(strA, str3, StringComparison.OrdinalIgnoreCase) == 0)
                {
                    item = base.vsaItems.CreateItem(attribute, VsaItemType.AppGlobal, VsaItemFlag.None);
                    ((IVsaGlobalItem) item).ExposeMembers = bool.Parse(element.GetAttribute("ExposeMembers"));
                    ((IVsaGlobalItem) item).TypeString = element.GetAttribute("TypeString");
                }
                else
                {
                    ...
                    item = base.vsaItems.CreateItem(attribute, VsaItemType.Code, VsaItemFlag.None);
                    XmlCDataSection firstChild = (XmlCDataSection) element.FirstChild;
                    string str6 = firstChild.Value.Replace(" >", ">");
                    ((IVsaCodeItem) item).SourceText = str6;
                }
        ...
        public ScriptObject PopScriptObject() => 
            ((ScriptObject) this.Globals.ScopeStack.Pop());
        ...
        private void SaveVsaItems(XmlDocument project, XmlElement parent)
        {
            ...
            foreach (IVsaItem item in base.vsaItems)
            {
                XmlElement elem = project.CreateElement("IVsaItem");
                ...
                else if ((string.Compare(name, "optimize", StringComparison.OrdinalIgnoreCase) != 0) && (string.Compare(name, "define", StringComparison.OrdinalIgnoreCase) != 0))
                {
                    ...
                    else if (string.Compare(name, "DebugDirectory", StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                throw new VsaException(VsaError.OptionInvalid, "", exception);
                            }
                            catch
                            {
                                throw new VsaException(VsaError.OptionInvalid);
        ...
        public Microsoft.JScript.LenientGlobalObject LenientGlobalObject =>
            ((Microsoft.JScript.LenientGlobalObject) this.Globals.globalObject);
