namespace Microsoft.JScript
{
    ...
    public class DatePrototype : DateObject
    {
        ...
        private static double Day(double time) => 
            Math.Floor((double) (time / 86400000.0));

        private static double DayFromYear(double year) => 
            ((((365.0 * (year - 1970.0)) + Math.Floor((double) ((year - 1969.0) / 4.0))) - Math.Floor((double) ((year - 1901.0) / 100.0))) + Math.Floor((double) ((year - 1601.0) / 400.0)));
        ...
        private static int DayWithinYear(double time) => 
            ((int) (Day(time) - DayFromYear(YearFromTime(time))));
        ...
        [JSFunction(JSFunctionAttributeEnum.HasThisObject, JSBuiltin.Date_getYear), NotRecommended("getYear")]
        ...
        [JSFunction(JSFunctionAttributeEnum.HasThisObject, JSBuiltin.Date_toGMTString), NotRecommended("toGMTString")]
