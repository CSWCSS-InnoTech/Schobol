namespace Microsoft.JScript
{
    ...
    public class DebugConvert : IDebugConvert, IDebugConvert2
    {
        ...
        public string Int16ToString(short value, int radix) => 
            System.Convert.ToString((short) Microsoft.JScript.Convert.ToInteger((double) value), radix);

        public string Int32ToString(int value, int radix) => 
            System.Convert.ToString((int) Microsoft.JScript.Convert.ToInteger((double) value), radix);

        public string Int64ToString(long value, int radix) => 
            System.Convert.ToString((long) Microsoft.JScript.Convert.ToInteger((double) value), radix);
        ...
        public string SingleToString(float value) => 
            Microsoft.JScript.Convert.ToString((double) value);
        ...
        public object ToPrimitive(object value, TypeCode typeCode, bool truncationPermitted) => 
            Microsoft.JScript.Convert.Coerce2(value, typeCode, truncationPermitted);
