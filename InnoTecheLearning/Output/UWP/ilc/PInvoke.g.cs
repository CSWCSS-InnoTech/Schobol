...
{
	/// <summary>
	/// P/Invoke class for module 'urlmon.dll'
	/// </summary>
	public unsafe static partial class urlmon_dll
	{
		// Signature, FindMimeFromData, [fwd] [return] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.AnsiStringMarshaller] string__unsigned char *, [fwd] [in] [Mcg.CodeGen.BlittableArrayMarshaller] rg_byte__unsigned char *, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.AnsiStringMarshaller] string__unsigned char *, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [out] [managedbyref] [nativebyref] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, 
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("\"CSWCSS eLearning App\", Version=0.10.0.0, Culture=neutral, PublicKeyToken=0948abeebd017cd5", "InnoTecheLearning.Utils+StreamPlayer", "FindMimeFromData")]
		public static uint FindMimeFromData(
					uint pBC, 
					string pwzUrl, 
					byte[] pBuffer, 
					uint cbSize, 
		...
		{
			// Setup
			byte* unsafe_pwzUrl = default(byte*);
			byte* unsafe_pBuffer;
			byte* unsafe_pwzMimeProposed = default(byte*);
			uint unsafe_ppwzMimeOut;
			uint unsafe___value;
			try
			{
				// Marshalling
				unsafe_pwzUrl = global::System.Runtime.InteropServices.McgMarshal.StringToAnsiString(pwzUrl, true, false);
				fixed (byte* pinned_pBuffer = global::McgInterop.McgCoreHelpers.GetArrayForCompat(pBuffer))
				{
					unsafe_pBuffer = (byte*)pinned_pBuffer;
					unsafe_pwzMimeProposed = global::System.Runtime.InteropServices.McgMarshal.StringToAnsiString(pwzMimeProposed, true, false);
					// Call to native method
					unsafe___value = global::McgInterop.urlmon_dll_PInvokes.FindMimeFromData(
										pBC, 
										unsafe_pwzUrl, 
										unsafe_pBuffer, 
										cbSize, 
										unsafe_pwzMimeProposed, 
										dwMimeFlags, 
										&(unsafe_ppwzMimeOut), 
										dwReserverd
									);
					global::System.Runtime.InteropServices.DebugAnnotations.PreviousCallContainsUserCode();
					ppwzMimeOut = unsafe_ppwzMimeOut;
				}
				// Return
			...
			{
				// Cleanup
				global::System.Runtime.InteropServices.ExternalInterop.SafeCoTaskMemFree(unsafe_pwzUrl);
				global::System.Runtime.InteropServices.ExternalInterop.SafeCoTaskMemFree(unsafe_pwzMimeProposed);
			}
		}
	}
	...
	public unsafe static partial class urlmon_dll_PInvokes
	{
		public static uint FindMimeFromData(
					uint pBC, 
					byte* pwzUrl, 
					byte* pBuffer, 
					uint cbSize, 
					byte* pwzMimeProposed, 
					uint dwMimeFlags, 
					uint* ppwzMimeOut, 
					uint dwReserverd)
		{
			throw new global::System.TypeLoadException(@"Unresolved P/Invoke method 'FindMimeFromData!urlmon.dll' in assembly '""CSWCSS eLearning App"", Version=0.10.0.0, Culture=neutral, PublicKeyToken=0948abeebd017cd5' because it is not available in UWP applications. Please either use an another API , or use [DllImport(ExactSpelling=true) to indicate that you understand the implications of using non-UWP application APIs.");
		}
	}
